  ...
  return (
    ...
    >
        <div className="container">
            ...
            <p className="mt-3 mb-4 max-w-[50ch] lg:max-w-[30ch] reveal-up" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.8' }}>
                Have an idea or project in mind? I&apos;d love to hear about it. Let&apos;s connect and create something great.
            </p>

            {/* Contact details */}
            <div className="flex flex-col gap-2 mb-6 reveal-up">
                <a href="tel:+918247226448" className="flex items-center gap-2 text-sm transition-colors footer-link" style={{ color: 'var(--color-text-secondary)' }}>
                    <span className="material-symbols-rounded text-base" style={{ color: 'var(--color-accent)' }}>phone</span>
                    +91 8247226448
                </a>
                <a href="mailto:shyamsriperumbuduru@gmail.com" className="flex items-center gap-2 text-sm transition-colors footer-link" style={{ color: 'var(--color-text-secondary)' }}>
                    <span className="material-symbols-rounded text-base" style={{ color: 'var(--color-accent)' }}>mail</span>
                    shyamsriperumbuduru@gmail.com
                </a>
                <a href="https://www.linkedin.com/in/shyam-sundar-s-sdn" target="_blank" className="flex items-center gap-2 text-sm transition-colors footer-link" style={{ color: 'var(--color-text-secondary)' }}>
                    <span className="material-symbols-rounded text-base" style={{ color: 'var(--color-accent)' }}>link</span>
                    linkedin.com/in/shyam-sundar-s-sdn
                </a>
            </div>
            ...
            <form
                action="https://getform.io/f/akkyyvwa"
                method="POST"
